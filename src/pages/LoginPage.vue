      ...
      <div class="col-12 col-md-12">
        ...
        <q-card align="center">
          <q-card-section align="center" class="bg-secondary">
            ...
            <span class="text-h3 text-weight-bolder login">
              LOG IN
            </span>
          </q-card-section>
          ...
          <q-card-section class="bg-primary">
            ...
            <q-card-section>
              ...
              >
                  ...
                  <q-input v-model="login.password" label="Password" :type="passwordVisibility ? 'text' : 'password'">
                    <template v-slot:before>
                  ...
                  <q-separator class="bg-transparent"/>
                    <q-btn color="green" text-color="white" label="Log In" @click="mainpage()"/>
                    <q-btn text-color="red" label="Reset" flat @click="onReset()"/>
                      <q-separator />
