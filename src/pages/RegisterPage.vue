<template>
  <q-page padding class="bg-grey-1">
          ...
          <q-card class="bg-primary" flat>
              ...
              <div class="q-pa-md">
                <q-form>
                  <div class="row">
                    ...
                    <div class="col-2 text-transparent bg-transparent">-</div>
                    ...
                    <div class="col-12 text-transparent bg-transparent">-</div>
                    ...
                    <div class="col-5">
                      ...
                      <q-input
                        ...
                        :rules="[
                          ...
                          (val) =>
                            val.length > 10 || 'Please enter your phone no.',
                        ]"
                      />
                    </div>
            ...
            <q-card-section align="right">
              <q-btn
                ...
                @click="submit = true"
              />
              <q-btn label="Cancel" class="text-red" @click="toLogin()" flat />
            </q-card-section>
          </q-card>
        </q-card-section>
      </q-card>
    ...
    <q-dialog v-model="submit" persistent>
      <q-card>
        <q-card-section>
          Registration succesful. Please go to login ....
        </q-card-section>
...
export default {
  setup() {
    ...
    function checkPassword(password) {
      ...
      return (
        pwdPattern.test(password) || "Password must contain mix characters!"
      );
    }
